  ...
  return (
    ...
    >
      ...
      <AnimatePresence mode="wait">
        ...
        >
          <motion.p
            className={"message-text" + (message.description ? " message-text-with-description" : "")}
            aria-label={`Messaggio ${currentIndex + 1} di ${totalMessages}: ${
              message.text
            }`}
            style={{
          ...
          >
            ...
            {message.description && (
              <>
              <br />
              <span className="message-description">{message.description}</span>
              </>
            )}
          </motion.p>
